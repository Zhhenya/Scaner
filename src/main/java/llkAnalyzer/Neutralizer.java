...
public class Neutralizer {
    ...
    public Neutralizer(Scanner scanner, Scanner.Lexeme lexeme, Types... expected) {
    ...
    public Neutralizer(Scanner scanner, Scanner.Lexeme lexeme, String first, String... lines) {
        StringBuilder builder = new StringBuilder();
